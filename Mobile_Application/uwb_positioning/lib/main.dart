  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        UserListPage.nameRoute: (context) => const UserListPage(),
        UserUpdatePage.nameRoute: (context) => const UserUpdatePage(),
        UserCreatePage.nameRoute: (context) => const UserCreatePage(),
        BorrowRequestManagePage.nameRoute: (context) => const BorrowRequestManagePage(),
        UserHomePage.nameRoute: (context) => const UserHomePage(),
        AdminHomePage.nameRoute: (context) => const AdminHomePage(),
        DeviceUpdatePage.nameRoute: (context) => const DeviceUpdatePage(),
        UserInfoPage.nameRoute: (context) => const UserInfoPage(),
        ChangePasswordPage.nameRoute: (context) => const ChangePasswordPage(),
        UserBorrowRequestPage.nameRoute: (context) => const UserBorrowRequestPage(),
      },
