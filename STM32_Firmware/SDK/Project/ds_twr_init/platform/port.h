...
// User define
#define DECASRVIRQ                  GPIO_Pin_1
#define DECASRVIRQ_GPIO             GPIOB
#define DECASRVIRQ_EXTI             EXTI_Line1
#define DECASRVIRQ_EXTI_PORT        GPIO_PortSourceGPIOB
#define DECASRVIRQ_EXTI_PIN         GPIO_PinSource1
#define DECASRVIRQ_EXTI_IRQn        EXTI1_IRQn
